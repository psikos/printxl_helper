...
import filtorwanie from "../../functions/filtrowanie";
...
const Produkcja = () => {
  ...
  useEffect(() => {
    wyszukaj === ""
      ...
      : filtorwanie(setFilteredWykonczenia, wyszukaj, wykonczenia);
    ...
    <>
      <div className="no-print">
        ...
        <p className="regularP">
          ...
          <strong>DTP_Produkcja</strong> - znajdziesz go w pasku szybkiego
          dostępu eksploratora Windows lub pod ścieżką: <br></br>
        ...
        <p className="regularP">
          ...
          Np. 20.10 dażymy do przygotowania wszystkich zleceń z datą druku
          21.10. Każde zlecenie z datą wcześniejszą, które nie zostanie
          przygotowane jest zaległością działu DTP.
        </p>
        <p className="regularP">
        ...
        <ul className="filter-list">
          ...
          <li>
            ...
            należy w kolumnie C wyszukać odpowiednią datę. Ważne - trzeba
            również odznaczyć opcję "puste".
          </li>
          <li>
      ...
      {wyswietl ? (
        <WyswietlWykonczenie props={wyswietl} isSzwalnia={false} />
      ) : null}
    </>
  );
};
